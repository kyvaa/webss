...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.php"><i class="fa fa-leanpub" aria-hidden="true"></i> WIRA74</a></h1>
					...
					<ul class="nav navbar-nav">
						...
						<li> <a class='effect-3 scroll' data-toggle='dropdown'>Jurusan<span class='caret'></span> </a>
							<ul class='dropdown-menu'>
								<li><a href='akutansi.php' >Asisten Perawat</a></li>
								<li><a href='rpl.php' >Teknik Komputer & Jaringan</a></li>
								<li><a href='otomotif.php' >Teknik bisnis Sepeda Motor</a></li>
							</ul>
						</li>
...
<table class="table text-left">	
    ...
    <tr>
        ...
        <td> <select name="Jurusan">
				...
				<option value="RPL"> TKJ </option>
				<option value="TKR"> TBSM </option>
			 </select>
       	</td>
    </tr>
...
<center><h2>FASILITAS</h2></center>
	...
	<div class="gallery">
		...
		<div class ="desc">
				<h3>Lab Farmasi Klinis</h3>
			</div>
		</div>
		<div class="gallery">
		<img src="images/upacara.jpg">
		<div class ="desc">
				<h3>Lapangan Upacara</h3>
			</div>
		</div>
		<div class="gallery">
		<img src="images/tkj1.jpg" >
		<div class ="desc">
				<h3>Lab Komputer</h3>
			</div>
		</div>
		<div class="gallery">
		<img src="images/tbsm1.jpg" >
		<div class ="desc">
				<h3>Bengkel Otomotif</h3>
			</div>
		</div>
		<div class="gallery">
		<img src="images/wira4.jpg">
		<div class ="desc">
				<h3>Lobi</h3>
			</div>
		</div>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© 2018 SMK WIRASABA | Design by <a href="https://www.instagram.com/oct4ky/">Kemzy.</a></p>
	</div>
</div>
<!-- //footer -->
